...
impl Device {
    pub unsafe fn hook_create_buffer(
        ...
        let result = self.CreateBuffer(device, p_create_info, p_allocator, p_buffer);
        if result < 0 {
            return result;
        }
    ...
    pub unsafe fn hook_bind_buffer_memory_2(
        ...
        let result = self.BindBufferMemory2(device, bind_info_count, p_bind_infos);
        if result < 0 {
            return result;
        }
    ...
    pub unsafe fn hook_bind_buffer_memory(
        ...
        let result = self.BindBufferMemory(device, buffer, memory, memory_offset);
        if result < 0 {
            return result;
        }
    ...
    pub unsafe fn hook_destroy_buffer(
        ...
        self.DestroyBuffer(device, buffer, p_allocator);
    }
}

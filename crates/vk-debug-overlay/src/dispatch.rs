...
pub struct InstanceDispatch {
    ...
    pub d: Vulkan_1_3_InstanceDispatch,
...
impl Deref for InstanceDispatch {
    type Target = Vulkan_1_3_InstanceDispatch;
...
impl InstanceDispatch {
    pub unsafe fn new(
        ...
        let instance_dispatch = Vulkan_1_3_InstanceDispatch::load_with(load_fn);
...
pub struct DeviceDispatch {
    pub device: VkDevice,
    pub d: Vulkan_1_4_DeviceDispatch,
...
impl DeviceDispatch {
    pub unsafe fn set_device_loader_data(&self, handle: impl VulkanHandle) {
        let _ = (self.set_device_loader_data)(self.device, handle.as_raw());
    }
}

impl Deref for DeviceDispatch {
    type Target = Vulkan_1_4_DeviceDispatch;
    fn deref(&self) -> &Self::Target {
        &self.d
    }
}
...
impl DeviceDispatch {
    pub unsafe fn new(
        ...
        let d = Vulkan_1_4_DeviceDispatch::load_with(load_fn);
...
unsafe impl DeviceDispatchableHandle for VkDevice {
    unsafe fn key(self) -> DispatchKey {
        DispatchKey::from_dispatchable_handle(self.as_raw())
    }
}

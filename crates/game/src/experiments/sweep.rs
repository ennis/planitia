...
impl SweepExperiment {
    pub fn new() -> Self {
        let sweep_stroke_pipeline =
            gamelib::render::pipeline_cache::get_compute_pipeline("/shaders/pipelines.parc#sweep_strokes");
        let debug_stroke_pipeline =
            gamelib::render::pipeline_cache::get_graphics_pipeline("/shaders/pipelines.parc#debug_swept_strokes");

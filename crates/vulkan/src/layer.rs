...
pub type PFN_GetPhysicalDeviceProcAddr =
    unsafe extern "C" fn(instance: VkInstance, pName: *const ::std::os::raw::c_char) -> PFN_vkVoidFunction;
...
pub type PFN_PhysDevExt = unsafe extern "C" fn(phys_device: VkPhysicalDevice) -> VkResult;
...
pub type PFN_vkLayerCreateDevice = unsafe extern "C" fn(
    instance: VkInstance,
...
pub type PFN_vkLayerDestroyDevice = unsafe extern "C" fn(
